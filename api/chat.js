...
function buildSystemInstruction(language, context) {
    if (language === 'ru') {
        ...
        'If the exact answer is unavailable, say so briefly and direct the user to request a quote or contact the team.',
            ...
            `Company info: ${context.company.name}, phone ${context.company.phone}, email ${context.company.email}, address ${context.company.address}, service area ${context.company.area}.`,
            'Policies:',
            ...context.policies,
            'Knowledge context:',
            context.contextText,
